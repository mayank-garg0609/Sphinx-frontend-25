...
const NavigationDots: React.FC<NavigationDotsProps> = memo(({ 
  ...
  const getResponsiveStyles = () => {
    if (isExtraLarge) {
      return {
        ...
        container: 'bg-black/70 backdrop-blur-3xl rounded-3xl p-8 border border-white/10 shadow-2xl shadow-black/50',
    ...
    if (isLargeDesktop) {
      return {
        ...
        container: 'bg-black/70 backdrop-blur-3xl rounded-3xl p-6 border border-white/10 shadow-2xl shadow-black/50',
    ...
    return {
      ...
      container: 'bg-black/70 backdrop-blur-3xl rounded-2xl p-4 border border-white/10 shadow-2xl shadow-black/50',
  ...
  return (
    <div className={styles.position}>
      <div className={`flex flex-col items-center ${styles.gap} ${styles.container}`}>
        <div className={`
        ...
        <nav className={`flex flex-col ${styles.gap}`} aria-label="Team member navigation">
            ...
            >
              ...
              <div
                className={`
                  ...
                  ${isExtraLarge || isLargeDesktop ? 'rounded-2xl' : 'rounded-xl'}
