          ...
          <div className="flex-1 flex items-center justify-center px-4 py-8">
            ...
            >
              <div className="relative aspect-[3/4] w-full rounded-3xl overflow-hidden shadow-2xl shadow-blue-500/20">
                {/* Stylish border frame with higher z-index for navigation arrows */}
                ...
                {activeIndex > 0 && (
                  <button
                    ...
                    className="absolute left-4 top-1/2 -translate-y-1/2 w-10 h-10 bg-black/50 backdrop-blur-sm rounded-full flex items-center justify-center text-white/80 hover:text-white transition-all duration-200 z-40"
                ...
                {activeIndex < teamData.length - 1 && (
                  <button
                    ...
                    className="absolute right-4 top-1/2 -translate-y-1/2 w-10 h-10 bg-black/50 backdrop-blur-sm rounded-full flex items-center justify-center text-white/80 hover:text-white transition-all duration-200 z-40"
                ...
                <div className="absolute top-4 right-4 bg-black/70 backdrop-blur-sm rounded-full px-3 py-1 text-xs font-mono text-white/90 z-35">
          ...
          <div className="px-6 py-6 space-y-6">
            <div className="relative">
              <div className="absolute left-0 top-1/2 -translate-y-1/2 pointer-events-none select-none overflow-hidden">
                <span
                  className="text-6xl md:text-7xl lg:text-[8rem] font-black leading-none opacity-[0.06] font-mono text-white/20"
                  aria-hidden="true"
                >
                  {activeMember.age}
                </span>
