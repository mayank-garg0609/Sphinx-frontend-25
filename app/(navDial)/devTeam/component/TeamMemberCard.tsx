...
const TeamMemberCard = forwardRef<HTMLLIElement, TeamMemberCardProps>(({ 
  ...
  const currentDimensions = isActive ? dimensions.active : dimensions.inactive;
    ...
    >
      <div
        className={`
          ...
          ${isActive
            ? `${isTablet ? 'rounded-2xl' : 'rounded-3xl'} shadow-2xl shadow-blue-500/20 ${currentDimensions.scale}`
            : `${isTablet ? 'rounded-xl' : 'rounded-2xl'} transform ${currentDimensions.scale} opacity-50`
          }
      ...
      >
        ...
        {isActive && (
          <>
            ...
            <div className={`absolute top-0 left-0 z-30 ${isTablet ? 'w-16 h-16' : 'w-20 h-20'}`}>
              <div className={`
                absolute border-l-3 border-t-3 border-blue-400 opacity-90
                ${isTablet 
            ...
            <div className={`absolute bottom-0 right-0 z-30 ${isTablet ? 'w-16 h-16' : 'w-20 h-20'}`}>
              <div className={`
                absolute border-r-3 border-b-3 border-cyan-400 opacity-90
                ${isTablet 
            ...
            <div className={`absolute top-0 right-0 z-30 ${isTablet ? 'w-12 h-12' : 'w-16 h-16'}`}>
              <div className={`
            ...
            <div className={`absolute bottom-0 left-0 z-30 ${isTablet ? 'w-12 h-12' : 'w-16 h-16'}`}>
              <div className={`
        ...
        <Image
          ...
          `}
          sizes={`
            ${isExtraLarge ? '(max-width: 768px) 256px, 384px' : 
              isLargeDesktop ? '(max-width: 768px) 256px, 320px' : 
              isTablet ? '(max-width: 768px) 224px, 288px' : 
