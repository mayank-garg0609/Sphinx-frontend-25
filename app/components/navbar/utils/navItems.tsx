...
const FaCalendarCheck = lazy(() => import('react-icons/fa').then(m => ({ default: m.FaCalendarCheck })));
const FaUserGraduate = lazy(() => import('react-icons/fa').then(m => ({ default: m.FaUserGraduate })));
const FaIdBadge = lazy(() => import('react-icons/fa').then(m => ({ default: m.FaIdBadge })));
const FaChalkboardTeacher = lazy(() => import('react-icons/fa').then(m => ({ default: m.FaChalkboardTeacher })));
const FaHandshake = lazy(() => import('react-icons/fa').then(m => ({ default: m.FaHandshake })));
const FaUserFriends = lazy(() => import('react-icons/fa').then(m => ({ default: m.FaUserFriends })));
const FaInfoCircle = lazy(() => import('react-icons/fa').then(m => ({ default: m.FaInfoCircle })));
...
export const navItems: readonly NavItem[] = Object.freeze([
  ...
  { id: "workshops", label: "Workshops", link: "/workshops", icon: FaChalkboardTeacher },
