...
function CountdownCard({ value, label, color }: CountdownCardProps) {
  const colorMap = {
    blue: "from-gray-900 to-black border-blue-500/40 shadow-[0_0_25px_rgba(59,130,246,0.9)] text-blue-400",
    purple: "from-gray-900 to-black border-purple-500/40 shadow-[0_0_25px_rgba(168,85,247,0.9)] text-purple-400",
...
export default function Countdown({ 
  ...
  return (
    <div className={`absolute bg-transparent flex flex-col items-center justify-center ${className}`}>
      {/* Stars Background */}
