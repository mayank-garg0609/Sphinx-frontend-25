...
export const BUTTON_STYLES = {
  ...
  secondary:
    "w-full flex items-center justify-center border border-white text-white font-medium py-2 lg:py-2 py-3 rounded-lg hover:bg-white hover:text-black transition text-sm lg:text-base gap-2 disabled:opacity-50 disabled:cursor-not-allowed",
} as const;
